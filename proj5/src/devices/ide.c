  ...
  for (chan_no = 0; chan_no < CHANNEL_CNT; chan_no++)
    {
      ...
      //printf("/* Before Initialize channel. */\n");
      /* Initialize channel. */
      ...
      //printf("/* Before Initialize devices. */\n");
      /* Initialize devices. */
      ...
      //printf("/* End Initialize devices. */\n");

      
      /* Register interrupt handler. */
      intr_register_ext (c->irq, interrupt_handler, c->name);
      //printf("/* Register interrupt handler. */\n");
      ...
      //printf("/* Distinguish ATA hard disks from other devices. */\n");
